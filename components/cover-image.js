...
export default function CoverImage({ title, url, imageObject, slug }) {
	const image = (
		<img
			...
			className={
				cn("shadow-small", {
					"hover:shadow-medium transition-shadow drop-shadow-[0_35px_35px_rgba(0,0,0,0.4)] dark:drop-shadow-[0_35px_35px_rgba(123,123,123,0.1)] dark:hover:drop-shadow-[0_35px_35px_rgba(123,123,123,0.12)] duration-200 rounded-2xl border-2 border-black ":
						slug,
